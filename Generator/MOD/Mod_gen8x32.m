...
% Samples/Symbol: 8 implies "128 Symbols per second"
...
filt = comm.RaisedCosineTransmitFilter('RolloffFactor',0.35,'FilterSpanInSymbols',4,'OutputSamplesPerSymbol', 8);
b = coeffs(filt);
filt.Gain = 1/max(b.Numerator);

for dataset = 1
    out = [];
    path = strcat('/home/user12/Saad_External/MODCOD_DataSet/MOD_DATASET/MOD_8Samp',num2str(dataset),'.h5');
