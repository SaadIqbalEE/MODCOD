...
for dataset = 1
    out = [];
    path = strcat('/home/user12/Saad_External/MODCOD_DataSet/MOD_DATASET/MOD_Rayleighfadded_16Samp_N_NN',num2str(dataset),'.h5');
        ...
        for i= 1:25
            ...
            D_counter = 1;
                for sel_SNR = 1:length(SNR)
                    ...
                    SD = 1/sqrt(2);
                    H=(normrnd(0,SD,[102400 1])+1i*normrnd(0,SD,[102400 1]));
